...
// // //                 className="px-4 py-2 border border-blue-300 rounded-md text-blue-600 hover:bg-blue-100 disabled:opacity-50"
// // //               >
// // //                 Prev
// // //               </button>
...
// //         {/* Left Form */}
// //         <div className="flex-1 bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-blue-100 w-full md:w-1/2 min-h-[600px]">
// //           <h3 className="font-semibold text-lg text-blue-600 mb-4">Add Milk Entry</h3>
// //           {msg && (
// //             <div className="mb-3 text-sm text-green-700 bg-green-100 border border-green-300 rounded p-2 text-center">
// //               {msg}
...
// //         {/* Right Table */}
// //         <div className="flex-1 bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-blue-100 overflow-hidden w-full md:w-1/2 min-h-[600px] flex flex-col">
// //           <h3 className="font-semibold text-lg text-blue-600 mb-4">Records</h3>
